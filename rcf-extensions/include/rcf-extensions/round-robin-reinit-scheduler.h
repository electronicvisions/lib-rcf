 ...
 * Using the define `RRWR_GENERATE(MyWorker, MyAlias)` below, we can generate a
...
public:
	...
	// inference done in extra helper struct for RRWR_GENERATE macro
